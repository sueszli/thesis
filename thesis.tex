...
The question discussed in the previous section is just one of many that remain open. In fact, there are several properties of adversarial examples that have yet to be fully explained~\cite{shamir2021dimpled}:

\begin{itemize}
	\item What are these adversarial examples?

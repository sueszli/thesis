...
% - add gpt usage stuff: https://informatics.tuwien.ac.at/study-services/master-graduation/
% - examples: https://catalogplus.tuwien.at/primo-explore/search?query=any,exact,E%20066%20645,AND&pfilter=dr_s,exact,20180101,AND&pfilter=dr_e,exact,20251231,AND&tab=default_tab&search_scope=UTW&sortby=rank&vid=UTW&mode=advanced&offset=0
...
% todo:
% 
% - split chapter 2 in two
% - improve plot readability
% - use citet / citep where possible
% - move the citation box [x] to the end of the sentences. you would only have it in the middle if it is part of a list, e.g., "This method has been applied for A [1-4], B [4,6], and C [7-9]."
...
\begin{acknowledgements}
	...
	I'm deeply grateful to those who supported me along the way. My parents, Shima and Florian and my family, for their unwavering support \textendash{} even when I quit my job to pursue my passion. My partner, Laura, whose love and encouragement crossed the Atlantic and carried me through many long nights.
...
% - attacking submission system model: https://www.usenix.org/system/files/usenixsecurity23-eisenhofer.pdf
% - automated zero-day exploit detection in sqlite: https://www.theregister.com/2024/11/05/google_ai_vulnerability_hunting/
% - osint and doxing people: https://www.theverge.com/2024/10/2/24260262/ray-ban-meta-smart-glasses-doxxing-privacy
% - osint and leaking locations: https://healeycodes.com/geoguessing-with-deep-learning
% - identifying browser tabs via browser throughput: https://jackcook.github.io/bigger-fish/
...
% interpretability: https://arxiv.org/pdf/2207.13243
...
use a casual but technical tone.
avoid jargon, but do not oversimplify.

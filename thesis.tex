...
% Firstly, we found that there is very little research on the human-targeting adversarial attacks by CAPTCHA providers, such as reCAPTCHA, hCaptcha, and others. These are the most widely used CAPTCHAs on the internet, and they are used to protect against bots. Given that they're already widely used by large companies, we believe that they are a starting point, proven to be effective, since otherwise they wouldn't be used. This makes hCaptcha inspired geometric masks a good starting point for our research.
...
% Secondly, the self-ensembling algorithm~\cite{fort2024ensemble} both performs exceptionally well and is a great architectual approach to increase both reliability and robustness of a model. The recency of the paper and the lack of follow-up research and reproducibility studies makes it a good candidate for further research.

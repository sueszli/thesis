...
\begin{figure}
	\centering
	\includegraphics[width=0.75\columnwidth]{figures/ctf-advx.png}
	\caption{Captcha the Flag: the reCAPTCHAv2 cybersecurity emulation framework \\ \url{https://github.com/ETH-DISCO/captcha-the-flag}}
	\label{fig:ctf}
\end{figure}
...
% We were inspired by hCaptcha, a new CAPTCHA system that overlays images with predictable patterns, like grids.

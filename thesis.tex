...
\begin{acknowledgements}
	...
	Thanks as well to those whose paths have diverged from mine but whose impact remains with me, including Prof.\ Schahram Dustdar, who first inspired me to pursue research and enabled me to study in Canada.
...
\begin{highlightbox}
	...
	Traditionally, adversarial examples are expected to have two key properties: (1) they should successfully cause misclassification in machine learning models while (2) remaining imperceptible to human observers~\cite{cubuk2017intriguing}. \\
...
Imperceptible noise is just one of many semantics preserving adversarial examples. For instance, rotating an image by a few degrees or capturing it from a different angle can also cause misclassification. These superset of adversarial examples are often referred to as ``unrestricted''~\cite{brown2018unrestricted} or ``semantics preserving''~\cite{browne2020semantics, careil2023towards, lee2020semantics} adversarial examples. The comparison in Fig.~\ref{fig:unrestricted} and the illustration in Fig.~\ref{fig:latentspace} serve to highlight the differences between the different kinds of adversarial examples. Fig.~\ref{fig:adversarial_dogs} shows a collection of naturally occurring adversarial examples, also known as ``natural adversarial examples''~\cite{hendrycks2021natural, teenybiscuittweet}.

This shift in how we define adversarial examples, first popularized through the ``Unrestricted Adversarial Examples Challenge''~\cite{brown2018unrestricted} by Google in 2018, has led to a more nuanced understanding of the phenomenon. It acknowledges that real-world applications, especially in safety-critical contexts, are subject to a broader range of adversarial attacks than previously assumed and do not always adhere to the ``small perturbation'' constraint that was initially proposed~\cite{brown2018unrestricted}.

This paradigm shift to a search for more meaningful adversarial examples and ``spacial robustness'' was first proposed by Gilmer et al. in 2018~\cite{gilmer2018motivating} and Engstrom et al. in 2019~\cite{engstrom2019exploring}. It lays the theoretical foundation for our work and we believe it to be the future of adversarial machine learning research.
...
\begin{figure}[h]
	...
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-bagel.jpeg}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-bear.jpeg}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-chicken.jpeg}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-crossaint.jpeg}
	\end{minipage}
	...
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-loaf.jpeg}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-mop.jpeg}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-muffin.jpeg}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.24\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/dog-vs-towel.jpeg}
	\end{minipage}
...
% Microsoft, Google, and Hugging Face are leading companies investing in AI security testing and adversarial example detection. Microsoft has established a dedicated AI Red Team to proactively identify and mitigate AI system vulnerabilities. Google has developed comprehensive AI red teaming procedures documented in their security framework.



% find motivation to use adversarial examples in safety critical systems.

% use names of companies for each example. try to find the amount of money they're spending for each example.
...
\section{Latents \& Shared Models of Reality}
...
The self-ensembling algorithm~\cite{fort2024ensemble} is a step in this direction we explore in this thesis. Additionally, we make use of primitive geometric masks as attacks, to study the underlying mechanisms of adversarial examples.

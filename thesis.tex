...
Even though the authors shared an implementation that includes new features like nature-based noise, mild FGSM training and random resolution shuffling \textendash{} some of which were not listed in the paper but appear in their codebase and may boost performance further \textendash{} 

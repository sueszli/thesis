...
\begin{highlightbox}
	\textbf{Definition:} Data Submanifold \\
	
	The first attempt to explain adversarial examples used the term ``manifold''.
...
\paragraph{Piecewise-linear decision boundaries.} In the \textit{dimpled manifold hypothesis}~\cite{shamir2021dimpled} the authors suggests that the geometry of the classifier's decision boundary 
...
\paragraph{Theoretical constructions which incidentally exploit non-robust features.}

...
we implemented the code for cifar10, cifar100 and Imagenette, but due to time constraints we only evaluated cifar10. these time constraints were due to the limited availability of GPUs and the long training times for the self-ensembled ResNet, which requires at least 80 GB of GPU memory.

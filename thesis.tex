...
\begin{itemize}
	...
	\item Why do robustness and accuracy trade-off?
\end{itemize}

There have been many attempts at finding a cohesive narrative to explain these properties, each with their own limitations and assumptions \textendash{} some complementary, some contradictory\footnote{For a more comprehensive overview of the hypotheses, see the Addendum of Ilyas et al.\ \cite{ilyas2019adversarial}}.

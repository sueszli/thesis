...
\begin{zusammenfassung}
	...
	% Das Maschinellelernwidrigkeitsforschungsgebietsuntersuchungswesen hat sich traditionellerweise auf Unmerklichkeitsveränderungsmanipulationsvorgehensweisen fokussieret, welche die Tiefeneuronalennetzwerkverarbeitungssysteme täuschen. Diese Masterarbeitsforschungsschriftendokumentation herausfordert selbige eingeschränkte Betrachtungsweisenmethodologie durch die Untersuchungsanalyse von uneingeschränkten Widersacherischenexemplifizierungsmanifestationen \textendash{} eine umfänglichere Klassifizierungskategorisierung von Manipulationsverfahrensweisenmethodologien, welche die Modellsicherheitsverhältnisgarantien kompromittieren können, während die Semantikbedeutungserhaltung bewahret wird.
	...
	% Diese Forschungsarbeitsbestrebung erweitert unser Verständnishorizontpotential widersacherischer Exemplifizierungsmanifestationen jenseits von Pixelraumperturbationsmodifikationen und stellet praktische Werkzeugunterstützungsmechanismen zur Verfügung.
	% Unsere Erkenntnisgewinnungsresultate unterstreichen die Notwendigkeitserfordernis, unsere Konzeptualisierungsherangehensweise und Evaluierungsmethodologien der widersacherischen Robustheitseigenschaftscharakteristika in Maschinellenlernverarbeitungssystemen zu überdenken.

	\textit{Adversarial Machine Learning} hat sich traditionell auf kaum wahrnehmbare Störungen konzentriert, die tiefe neuronale Netze täuschen. Diese Arbeit hinterfragt diese Sichtweise, indem sie uneingeschränkte adversarielle Beispiele untersucht \textendash{} eine breitere Klasse von Manipulationen, die die Sicherheit von Modellen gefährden können, während die Semantik erhalten bleibt.

	Durch umfangreiche Experimente leisten wir drei wesentliche Beiträge: Erstens zeigen wir durch eine umfassende Untersuchung der aktuellen Forschung, dass die Standardanforderung der Unwahrnehmbarkeit nicht ausreicht, um reale adversarielle Bedrohungen zu charakterisieren. Zweitens entwickeln wir eine neuartige und recheneffiziente Methode zur Generierung adversarieller Beispiele mithilfe geometrischer Masken, die von hCAPTCHA-Herausforderungen inspiriert sind. Unser Ansatz erzeugt adversarielle Beispiele, die (1) effektiv, (2) zwischen Modellen übertragbar und (3) in der Entscheidungsstruktur des Modells nachvollziehbar sind \textendash{} und dabei vergleichbare Fehlklassifikationsraten wie bestehende Techniken bei deutlich geringerem Rechenaufwand erzielen. Schließlich untersuchen wir die Verbesserung der Modellrobustheit, indem wir Ensembles aus Zwischenebenen von ResNet mithilfe linearer Sonden erstellen und während des Trainings naturinspirierte Störungen einführen. Obwohl dieser architektonische Ansatz vielversprechend ist, stellen wir fest, dass ``kostenlose Robustheit'' ohne adversarielles Training nicht erreichbar bleibt.

	Diese Arbeit erweitert unser Verständnis adversarieller Beispiele über Pixelraum-Störungen hinaus und bietet praktische Werkzeuge sowohl für deren Generierung als auch zur Verteidigung dagegen.
	Unsere Ergebnisse verdeutlichen die Notwendigkeit, das Konzept und die Bewertung adversarieller Robustheit in maschinellen Lernsystemen neu zu überdenken.
\end{zusammenfassung}

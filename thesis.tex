...
The self-ensembling algorithm~\cite{fort2024ensemble} is a step in this direction we will be exploring in this thesis. Additionally, we will make use of primitive geometric masks as attacks, to study the underlying mechanisms of vision models.
...
% Self-ensembled learning

% Geometric masks inspired by hCaptcha

% add screenshots of recaptchav2 bot

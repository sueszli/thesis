...
% based off andreas' previous recaptchav2 paper


% The methods section details the research process by describing:
% - The exact procedures used to conduct the study2
% - Materials, participants, or study groups involved2
% - Data collection instruments and procedures3
% - Statistical tests and parameters used2
% - Study design and sampling strategy3

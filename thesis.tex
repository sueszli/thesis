...
The self-ensembling algorithm~\cite{fort2024ensemble} is a step in this direction we explore in this thesis. Additionally, we make use of primitive geometric masks as attacks, to study the underlying mechanisms of vision models.
